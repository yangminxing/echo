import { defineComponent as tn, computed as pe, toRefs as en, unref as V, ref as nn, reactive as on, h as rn, getCurrentInstance as ue, watch as an, onMounted as ln, nextTick as Ne, onUnmounted as sn, isRef as Gt } from "vue";
...
function hn(t) {
  return Object.keys(t).reduce((n, e) => (typeof t[e] < "u" && (n[fn(e)] = t[e]), n), {});
}
function me(t, n) {
...
var u, x, v, C, ft, Rt, T, lt, mt, L, Ct, at, It, X, gt = !1, Ht = !1, Wt = [], ct, J, Zt, Kt, Te, xe, wt, pt, Tt, xt = !1, Mt = !1, Yt, B, Qt = [], re = !1, Vt = [], Lt = typeof document < "u", Nt = Xe, Oe = Ot || it ? "cssFloat" : "float", Rn = Lt && !Be && !Xe && "draggable" in document.createElement("div"), Le = (function() {
  if (Lt) {
    if (it)
      return !1;
...
g.prototype = /** @lends Sortable.prototype */
{
  ...
  option: function(t, n) {
    ...
    typeof o < "u" ? e[t] = o : e[t] = n, t === "group" && Ge(e);
  },
  /**
   * Destroy
   */
